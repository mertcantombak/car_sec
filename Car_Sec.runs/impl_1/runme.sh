...
HD_PWD='C:/Users/90531/Car_Sec/Car_Sec.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log CAR_SEC.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source CAR_SEC.tcl -notrace
